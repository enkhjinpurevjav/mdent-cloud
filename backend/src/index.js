...
import financeEncountersRouter from "./routes/financeEncounters.js";
...
app.use("/api/users", (req, res, next) => {
  ...
  if (req.method === "GET" && req.path === "/nurses/by-branch") {
    return next();
  }
...
app.use("/api/finance/encounters", financeEncountersRouter);

...
import type {
  ...
  VisitCard,
  VisitCardType,
} from "../pages/patients/[bookNumber]";
...
type Props = {
  ...
  updateVisitCardAnswer: <K extends keyof VisitCardAnswers>(
    key: K,
    value: VisitCardAnswers[K]
  ) => void;
  updateNested: (
...
export default function ChildVisitCardForm({
  ...
  return (
    ...
    >
      ...
      {/* Prevention section – REUSE exact adult block here */}
      {/* You can factor it into a shared component later; for now duplicate from the page:
          Урьдчилан сэргийлэх асуумж + reasons + Q1 + Q2 + dentistAttentionNotes
          wired to answers.reasonToVisit, answers.previousDentalVisit, answers.dentistAttentionNotes
      */}

      {/* 3) Ерөнхий биеийн талаархи асуумж (same structure, kids wording via labels) */}
      <section style={{ marginTop: 16 }}>
        ...
        >
          ...
          <tbody>
            {/* ---- Ерөнхий бие (same keys as adult, child labels) ---- */}
            {([
            ...
            {([
              ...
              const detailValue =
                (answers.allergies as any)?.[detailKey] || "";
              return (
                <React.Fragment key={key}>
                  <tr>
                    <td
            ...
            {([
              ...
              const detailKey =
                key === "other" ? "otherDetail" : `${key}Detail`;
              const detailValue =
                (answers.habits as any)?.[detailKey] || "";
              return (
                <React.Fragment key={key}>
                  <tr>
                    <td
            ...
            {([
              ...
              const detailKey = `${key}Detail`;
              const detailValue =
                (answers.dentalFollowup as any)?.[detailKey] || "";
              return (
                <React.Fragment key={key}>
                  <tr>
                    <td
      ...
      >
        ...
        <ol style={{ paddingLeft: 18, margin: 0, marginBottom: 8 }}>
          ...
          <li style={{ marginBottom: 4 }}>
            ...
            асуудал гардаг ба тухайн асуудлыг үйлчлүүлэгчийн эцэг эх хариуцна.
          </li>
          <li style={{ marginBottom: 4 }}>
          ...
          <li style={{ marginBottom: 4 }}>
            Та хийлгэсэн эмчилгээний дараахь эмчийн хэлсэн заавар зөвлөмжийг
            дагаж биелүүлэх үүрэгтэй ба ингэснээр эмчилгээ үр дүнгүй болох,
            дараачийн хүндрэлүүд үүсэх зэрэг асуудлаас өөрийгөө сэргийлж
            байгаа юм.
          </li>
          <li style={{ marginBottom: 4 }}>

...
// Order in which we cycle statuses
const STATUS_ORDER: ToothStatus[] = ["none", "to_extract", "extracted", "caries"];

// How to display each status inside the tooth circle
const STATUS_LABEL: { [K in ToothStatus]: string } = {
  none: "",
  to_extract: "×",
  extracted: "Ø",
  caries: "C",
 ...
 * - Fixed adult FDI codes for upper/lower, left/right
 * - Clicking a tooth cycles through a small set of statuses
 */

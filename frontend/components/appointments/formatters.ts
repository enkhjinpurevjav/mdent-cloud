...
/** @deprecated Use formatDateYmdDash instead. Output is now YYYY-MM-DD (dash-separated). */
export const formatDateYmdDots = formatDateYmdDash;
...
export function formatDetailedTimeRange(
  ...
  const datePart = startParsed.ymd;

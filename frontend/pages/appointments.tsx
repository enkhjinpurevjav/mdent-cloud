...
const QuickAppointmentModal: FC<QuickAppointmentModalProps> = ({
  open,
  onClose,
  defaultDoctorId,
  defaultDate,
...
const AppointmentsPage: FC = (): ReactElement => {
  ...
  // ===== 2-lane grid per doctor for selected day =====
  ...
  const slotsPerHour = 60 / SLOT_MINUTES; // not used but kept for future
              ...
              {timeSlots.map((slot, rowIndex) => (
                ...
                >
                  ...
                  {gridDoctors.map((doc) => {
                    ...
                    const laneBgLocal = (a: Appointment): string =>
                      laneBg(a);
                      ...
                      >
                        <div
                          style={{
                            ...
                            justifyContent: "center",
                            padding: "1px 3px",
                            backgroundColor: laneBgLocal(lane0!),
                        ...
                        <div
                          style={{
                            ...
                            justifyContent: "center",
                            padding: "1px 3px",
                            backgroundColor: laneBgLocal(lane1!),
                            boxSizing: "border-box",
                          }}
                          title={
                            lane1IsStart
      ...
      <section>
        ...
        {appointments.length === 0 ? (
          ...
          >
            <thead>
              <tr>
                {["ID", "Өвчтөн", "Салбар", "Эмч", "Огноо / цаг", "Төлөв", "Тэмдэглэл"].map(
                  (h) => (
                    <th
                      key={h}
                      style={{

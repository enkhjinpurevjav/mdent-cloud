    ...
    >
      ...
      {!loading && !error && (
        ...
        >
          ...
          {/* ЗУРШИЛ, УТТС / ХОЛБООС, ЭРҮҮНИЙ ҮЕ, УРУУЛ */}
          <div
            style={{
              marginTop: 0,
              marginBottom: 16,
          ...
          >
            ...
            {/* RIGHT COLUMN: ХОЛБООС + ЭРҮҮНИЙ ҮЕ + УРУУЛ */}
            <div
              style={{
                display: "flex",
                flexDirection: "column",
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={() =>
                        toggleAttachmentBool("gingivitis")
                      }
                    />
                  </label>
                  <label
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={() =>
                        toggleAttachmentBool("gingivitisNo")
                      }
                    />
                  </label>

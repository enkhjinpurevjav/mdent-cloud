    ...
    >
      ...
      {!loading && !error && (
        ...
        >
          ...
          {/* (exactly as above in previous answer) */}

          {/* Odontogram + legend */}
          {/* MODEL MEASUREMENTS */}
          {/* TOTAL DISCREPANCY */}
          {/* Actions */}
          {/* keep as in this file above */}

          {/* For brevity, these lower sections are already fully defined above.
              Make sure not to duplicate them. */}
        </section>
      )}
    </main>
  );

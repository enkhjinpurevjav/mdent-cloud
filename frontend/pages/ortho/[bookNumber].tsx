...
import { createEmptyChartState } from "../../types/orthoCard";
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        } else if (json?.orthoCard?.patientBookId) {
          setPatientBookId(json.orthoCard.patientBookId);
        }
